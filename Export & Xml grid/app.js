...
Ext.application({
    ...
    extend: 'Trail.Application',

    requires: [
        'Trail.view.main.Main'
    ],
    ...
    //
    mainView: 'Trail.view.main.Main'

    //-------------------------------------------------------------------------
    // Most customizations should be made to Trail.Application. If you need to
...
//     launch: function() {
//         // Ext.Msg.alert('Grid to Excel Example', 'Welcome!');
...
//                  ftype: 'grouping',
//                  groupHeaderTpl: [
//                      '{columnName}: {name} <span style=\'margin-left: 10px\'>(Count: {[values.children.length]})</span>'
//                  ],
